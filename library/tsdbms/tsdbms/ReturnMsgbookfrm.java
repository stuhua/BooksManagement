...
{
	JLabel l_msg,l_uuser,l_user,l_bookname,l_data,l_beizhu;
	...
	ReturnMsgbookfrm()
	{
		...
		pan4.add(l_data);pan4.add(t_data);pan5.add(l_beizhu);pan5.add(t_beizhu);pan6.add(b_clear);pan6.add(b_update);pan6.add(b_back);
	...
	public void actionPerformed(ActionEvent ed)
	{
		...
		else if(ed.getSource()==b_update)
		{
			try
			{
				...
				String tem="UPDATE bookbrowse SET studentname="+a3+",bookname="+a4+",returndata="+a5+",beizhu="+a2+" WHERE studentname="+a3;
				sqll.executeUpdate(tem);
				l_msg.setText("滞纳金缴纳完毕");
			}
